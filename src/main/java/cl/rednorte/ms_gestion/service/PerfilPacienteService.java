...
import cl.rednorte.ms_gestion.entity.Usuario; // IMPORTANTE: Asegúrate de importar esto
import cl.rednorte.ms_gestion.dto.PerfilPacienteRequest;
import cl.rednorte.ms_gestion.repository.PerfilPacienteRepository;
import cl.rednorte.ms_gestion.repository.UsuarioRepository; // IMPORTANTE: Asegúrate de importar esto
...
public class PerfilPacienteService {
    ...
    @Autowired 
    private UsuarioRepository usuarioRepo; // Inyectamos el repositorio de usuarios
